...
| 🤖  | **AI Assistant**       | Chat with Grok for personalized nutrition advice with streaming responses                   |
...
- **Calendar integration** — Training sessions appear on the calendar with add, edit, and cancel support
